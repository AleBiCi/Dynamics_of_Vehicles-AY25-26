...
FX0_fz_var_vec1 = MF96_FX0_vec(KAPPA_vec,zeros_vec ,ones_vec, mean(FZ_220.FZ)*ones_vec,tyre_coeffs);
FX0_fz_var_vec2 = MF96_FX0_vec(KAPPA_vec,zeros_vec ,ones_vec, mean(FZ_700.FZ)*ones_vec,tyre_coeffs);
FX0_fz_var_vec3 = MF96_FX0_vec(KAPPA_vec,zeros_vec ,ones_vec, mean(FZ_900.FZ)*ones_vec,tyre_coeffs);
FX0_fz_var_vec4 = MF96_FX0_vec(KAPPA_vec,zeros_vec ,ones_vec, mean(FZ_1120.FZ)*ones_vec,tyre_coeffs);
...
hold on
plot(KAPPA_vec,FX0_varGamma_vec,'-','Linewidth',2,'DisplayName','Fx')
xlabel('$\kappa$ [-]')
ylabel('$F_{x0}$ [N]')
legend 
